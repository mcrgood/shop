<?php
namespace  data\extend\chuanglan;
...
class ChuanglanSmsApi {
    ...
    private $api_account = "N2645740";
    private $api_password = "4FqN5LeQvI7cf9";
    private $API_VARIABLE_URL = "http://smssh1.253.com/msg/variable/json";
