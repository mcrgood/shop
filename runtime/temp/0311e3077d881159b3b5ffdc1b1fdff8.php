<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Config\webConfig.html";i:1514959763;s:28:"template/adminblue\base.html";i:1514959763;s:45:"template/adminblue\controlCommonVariable.html";i:1514959763;s:32:"template/adminblue\urlModel.html";i:1514959763;s:34:"template/adminblue\pageCommon.html";i:1514959763;s:34:"template/adminblue\openDialog.html";i:1514959763;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<p>
				<img src="<?php echo __IMG($qrcode_path); ?>" onerror="this.src=''">
			</p>
	...
	<dl>
		...
		<dd>
			<div class="class-logo">
				<p>
					<img id="imglogo" src="<?php echo __IMG($website['logo']); ?>" onerror="this.src=''">
				</p>
			</div>
	...
	<dl>
		...
		<dd>
			<div class="class-logo">
				<p>
					<img id="imgweb_qrcode" src="<?php echo __IMG($website['web_qrcode']); ?>" onerror="this.src=''">
				</p>
			</div>
			<div class="upload-btn">
				<span>
	...
	<dl>
		...
		<dd>
			<div class="class-logo">
				<p>
					<img id="imgwechat_share_logo" src="<?php echo __IMG($website['web_wechat_share_logo']); ?>" onerror="this.src=''">
				</p>
			</div>
			<div class="upload-btn">
				<span>
