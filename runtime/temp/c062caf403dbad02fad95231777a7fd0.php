<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:38:"template/shop\blue\Goods\category.html";i:1506594225;s:28:"template/shop\blue\base.html";i:1510626415;s:32:"template/shop\blue\urlModel.html";i:1510819885;s:34:"template/shop\blue\controlTop.html";i:1510735900;s:41:"template/shop\blue\controlHeadSerach.html";i:1510131274;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1503280183;s:43:"template/shop\blue\controlHeadGoodType.html";i:1506594225;s:40:"template/shop\blue\controlCommonNav.html";i:1502706001;s:43:"template/shop\blue\controlRightSidebar.html";i:1510626415;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1509523953;s:37:"template/shop\blue\controlBottom.html";i:1506764862;s:36:"template/shop\blue\controlLogin.html";i:1508897749;s:37:"template/shop\blue\baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- 添加css、字体文件文件 -->
<link type="text/css" rel="stylesheet" href="__TEMP__/<?php echo $style; ?>/public/css/ns_category_all.css">
...
<div class="w1210">
	<div class="breadcrumb clearfix">
		...
		<span class="last"><?php echo lang('all_goods_classification'); ?></span>
	</div>
	<?php if(!(empty($goods_category_one) || (($goods_category_one instanceof \think\Collection || $goods_category_one instanceof \think\Paginator ) && $goods_category_one->isEmpty()))): ?>
	...
	<?php foreach($goods_category_one as $vo): ?>
		<div class="all-category-floor">
			<div class="floor-top">
				<div class="title"><a href="<?php echo __URL('SHOP_MAIN/goods/goodslist','category_id='.$vo['category_id']); ?>"><?php echo $vo['category_name']; ?></a></div>
			</div>
			<div class="floor-bot">
				<div class="floor-category-list">
					<?php if($vo['child_list'] != null): foreach($vo['child_list'] as $vo2): if($vo2['pid'] == $vo['category_id']): ?>
						<dl>
							<dt><a href="<?php echo __URL('SHOP_MAIN/goods/goodslist','category_id='.$vo2['category_id']); ?>" target="_blank"><?php echo $vo2['category_name']; ?></a></dt>
							<dd>
							<?php if($vo2['child_list'] != null): foreach($vo2['child_list'] as $vo3): if($vo3['pid'] == $vo2['category_id']): ?>
								<a href="<?php echo __URL('SHOP_MAIN/goods/goodslist','category_id='.$vo3['category_id']); ?>" target="_blank"><?php echo $vo3['category_name']; ?></a>
	...
	<div class="notGoodsCategory">
		<img src="__TEMP__/<?php echo $style; ?>/public/images/notCateGory.png" alt="">
		<p><?php echo lang('no_goods_classification'); ?></p>
	</div>
	<?php endif; ?>
</div>
