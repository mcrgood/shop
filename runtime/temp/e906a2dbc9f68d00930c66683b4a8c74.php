<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:49:"template/adminblue\System\addShopAdvPosition.html";i:1514959763;s:28:"template/adminblue\base.html";i:1514959763;s:45:"template/adminblue\controlCommonVariable.html";i:1514959763;s:32:"template/adminblue\urlModel.html";i:1514959763;s:34:"template/adminblue\pageCommon.html";i:1514959763;s:34:"template/adminblue\openDialog.html";i:1514959763;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function addShopAdvPositionAjax() {
	...
	if(verify(ap_name,ap_display,ap_width,ap_height)){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/system/addshopadvposition'); ?>",
			data : {
				'ap_name' : ap_name,
				'ap_intro' : ap_intro,
				'ap_class' : ap_class,
			...
			success : function(data) {
				if (data["code"] > 0) {
					showMessage('success', "添加成功","<?php echo __URL('ADMIN_MAIN/system/shopadvpositionlist'); ?>");
				}else{
