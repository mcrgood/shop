<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"template/adminblue\System\updateShopAdvPosition.html";i:1514959763;s:28:"template/adminblue\base.html";i:1514959763;s:45:"template/adminblue\controlCommonVariable.html";i:1514959763;s:32:"template/adminblue\urlModel.html";i:1514959763;s:34:"template/adminblue\pageCommon.html";i:1514959763;s:34:"template/adminblue\openDialog.html";i:1514959763;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="ap_name" type="text" value="<?php echo $info['ap_name']; ?>" class="input-common"></p>
	...
	<dl>
		<dt>广告位关键字:</dt>
		<dd>
			<p><input name="UserCode" id="ap_keyword" type="text" class="input-common" maxlength="60" onkeyup="value=value.replace(/[^a-zA-Z]/ig,'')" onpaste="return false" value="<?php echo $info['ap_keyword']; ?>"></p>
	...
	<dl>
		<dt>简介:</dt>
		<dd>
			<p><textarea id="editor" class="input-common"><?php echo $info['ap_intro']; ?></textarea></p>
		</dd>
	</dl>
	<dl>
		<dt>类别:</dt>
	...
	<dl>
		...
		<dd>
			<p>
				<input id="is_use" type="checkbox" class="checkbox" <?php if($info['is_use'] == 1): ?>checked<?php endif; ?>>
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p>
				<label style="display: inline-block;font-weight:normal;"><input type="radio" name="type" id="type1" value="1" <?php if($info['type'] == 1): ?> checked <?php endif; ?>> PC端</label>
				<label style="display: inline-block;font-weight:normal;margin-left:70px;"><input type="radio" name="type" id="type2" value="2" <?php if($info['type'] == 2): ?> checked <?php endif; ?>> 手机端</label>
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p id="ap_display">
				<label style="font-weight:normal;"><input type="radio" name="ap_display" id="ap_display0" value="0"  <?php if($info['ap_display'] == 0): ?>checked<?php endif; ?>> 可以发布多条并幻灯展示</label>
				<label style="font-weight:normal;"><input type="radio" name="ap_display" id="ap_display1" value="1"  <?php if($info['ap_display'] == 1): ?>checked<?php endif; ?>>  可以发布多条广告并随机展示</label>
				<label style="font-weight:normal;"><input type="radio" name="ap_display" id="ap_display2" value="2" <?php if($info['ap_display'] == 2): ?>checked<?php endif; ?>> 只允许发布并展示一条广告</label>
			</p>
	...
	<dl>
		...
		<dd>
			<p><input id="ap_width" type="number" value="<?php echo $info['ap_width']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="ap_height" type="number" value="<?php echo $info['ap_height']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<div class="class-logo"><p><img id="imgLogo" <?php if($info['default_content'] !=''): ?> src="<?php echo __IMG($info['default_content']); ?>" <?php endif; ?> ></p></div>
	...
	<dl>
		<dt>默认背景色:</dt>
		<dd>
			<input id="ap_background_color" type="color" style="width:60px;height:25px;" value="<?php echo $info['ap_background_color']; ?>" class="input-common" />
		</dd>
	</dl>
	<dl>
		<dt></dt>
...
$("#ap_keyword").change(function(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/system/check_apkeyword'); ?>",
...
function updateShopAdvPositionAjax() {
	...
	if($("#Logo").val().length > 0){
		...
		var default_content = "<?php echo $info['default_content']; ?>"; 
	}
	...
	if(verify(ap_name,ap_display,ap_width,ap_height)){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/system/updateshopadvposition'); ?>",
			data : {
				'ap_name' : ap_name,
				'ap_id' : ap_id,
				'ap_intro' : ap_intro,
			...
			success : function(data) {
				if (data["code"] > 0) {
					showMessage('success', "编辑成功","<?php echo __URL('ADMIN_MAIN/system/shopadvpositionlist'); ?>");
				}else{
