<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"template/wap\default\Login\register.html";i:1514963714;s:34:"template/wap\default\urlModel.html";i:1514959765;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
		...
		<!-- <form action="" method="post"> -->
			<?php if(strpos($reg_config['register_info'],'mobile') !== false): if(strpos($reg_config['register_info'],'plain') === false): ?>
				...
				<div class="nk-cont" style="margin-top:45px;">
						<label><span  style="padding-right:20px;"><?php echo lang('cell_phone_number'); ?></span><input type="text"name="mobile" id="mobile" placeholder="<?php echo lang('please_enter_your_cell_phone_number'); ?>" onchange="check_mobile_is_has();"><i class="right_login_mobile" style="margin-right: 6px;">
					</i> 
						</label>
				</div>
			   ...
			   <?php endif; if($loginConfig['mobile_config']['is_use'] == 1): ?>
				...
				<div class="reg-cont">
					<label for="password"><span style="padding-right:32px;"><?php echo lang('password'); ?></span><input
						...
						placeholder="<?php echo lang('please_enter_your_account_password'); ?>"> <i class="right_login_pass"> </i>
					</label>
				</div>
				<div class="reg-cont">
					<label for="cfpassword"><span style="padding-right:8px;"><?php echo lang('member_confirm_password'); ?></span><input
						...
						placeholder="<?php echo lang('please_confirm_the_account_password'); ?>"> <i class="right_login_cfpass">
					</i>
					</label>
				</div>
